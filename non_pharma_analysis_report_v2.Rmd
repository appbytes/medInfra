...
### Top 20 High-Priority Non-Pharmaceutical Items (Class A)

```{r top-nonpharma-items}
...
DT::datatable(top_items, 
              ...
              filter = 'top',
              caption = "Top 20 A-Class Non-Pharmaceutical Items - Primary Market Entry Targets") %>%
  formatStyle(columns = 1:5, fontSize = '12px')
```

<div class="alert alert-warning">
<strong>💡 Market Entry Strategy:</strong> These top 20 non-pharmaceutical items represent your best opportunities for quick market penetration. Focus on building relationships with departments that heavily use these supplies.
</div>
